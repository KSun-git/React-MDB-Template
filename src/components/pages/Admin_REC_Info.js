...
import './Admin_REC_Info.css';
class Admin_REC_Info extends Component {
	state= {
		isLoading: false,
    ...
    return (
		<div className="Admin_REC_Info div_content" style={{marginTop:"70px"}}>
			
            {/* 타이틀 */}
            <MDBCard>
				<MDBCardBody className="titleCardBody">
					<span id="content_title">REC이행내역 상세/수정 </span><span style={{color:"red"}}>(권한&gt;관리자)</span>
				</MDBCardBody>
			</MDBCard>
						...
						<>
							...
							<form className="REC_Edit_frm">
                                <MDBTable responsive bordered className="REC_Info_Table2 text-center mt-2">
                                    ...
                                    <MDBTableBody>
                                        <tr>
                                            <td><input type="text" defaultValue="ooooooooooooo" className="Edit_frm_Input"></input></td>
                                            <td><input type="text" defaultValue="ooooooooooooo" className="Edit_frm_Input"></input></td>
                                            <td><input type="text" defaultValue="ooooooooooooo" className="Edit_frm_Input"></input></td>
                                            <td><input type="text" defaultValue="ooooooooooooo" className="Edit_frm_Input"></input></td>
                                            <td><input type="text" defaultValue="ooooooooooooo" className="Edit_frm_Input"></input></td>
