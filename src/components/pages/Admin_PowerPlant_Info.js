...
import './Admin_PowerPlant_Info.css';

class Admin_PowerPlant_Info extends Component {
    state = {
		items: {
			default: "1",
		},
    ...
    render() {
        ...
        return (
            <div className="Admin_PowerPlant_Info div_content">
				<MDBCard>
...
export default Admin_PowerPlant_Info;